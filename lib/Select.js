...
var FormSelect = function (_React$Component) {
  ...
  _createClass(FormSelect, [{
    ...
    key: '__onSelected__REACT_HOT_LOADER__',
    value: function __onSelected__REACT_HOT_LOADER__(event, selectedIndex, menuItem) {
      this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Input.InputLabel,
            { htmlFor: 'period-dropdown' },
            this.props.form.title
          ),
          _react2.default.createElement(
            _Select2.default,
            {
              input: _react2.default.createElement(_Input2.default, { id: 'period-dropdown' }),
