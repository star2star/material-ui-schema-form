...
var Array = function (_Component) {
  ...
  function Array() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Array.__proto__ || Object.getPrototypeOf(Array)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      model: _utils2.default.selectOrSet(_this.props.form.key, _this.props.model) || []
    }, _this.onAppend = function () {
      var _this2;

      return (_this2 = _this).__onAppend__REACT_HOT_LOADER__.apply(_this2, arguments);
    }, _this.onDelete = function () {
      var _this3;

      return (_this3 = _this).__onDelete__REACT_HOT_LOADER__.apply(_this3, arguments);
  ...
  _createClass(Array, [{
    ...
    value: function render() {
      ...
      var _loop = function _loop(i) {
        var boundOnDelete = _this4.onDelete.bind(_this4, i);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(RaisedButton, { label: form.add || 'Add', secondary: true, onTouchTap: this.onAppend })
      );
    }
  }]);
